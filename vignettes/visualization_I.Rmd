...
This idea can be explored with a scatterplot.
...
From this perspective there appears to be a correlation among mapping quality and depth.
This can be validated by calculating a correlation.



```{r}
cor.test(chrom@var.info$DP, chrom@var.info$MQ)
```
